...
public Formula ParsedFormula { get; private set; }
	...
	void LogicalExpr(out IExpressionNode node) {
		...
		while (StartOf(2)) {
			...
			AddExpr(out child);
			leftSide = makeBooleanAritmenthics(leftSide, child, currentOperator); 
		}
		node = leftSide; 
	}
	...
	void MultExpr(out IExpressionNode node) {
		...
		while (StartOf(3)) {
			...
			string currentOperator = t.val; 
			ExpExpr(out child);
			leftSide = makeMultiplications(leftSide, child, currentOperator); 
		}
		node = leftSide; 
	}
	...
	void UnaryExpr(out IExpressionNode node) {
		...
		Term(out child);
		node = makeUnaryOperation(child, currentOperator); 
	}
	...
	static readonly bool[,] set = {
		...
		{_x,_x,_x,_x, _T,_T,_T,_T, _T,_T,_T,_T, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x},
		{_x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_T,_T, _T,_T,_T,_T, _T,_T,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x},
