...
namespace Stareater.GameData
{
	class ResearchProgress 
	{
		...
		//TODO(v0.8) consider moving to player processor and merging with development progress
		//TODO(v0.8) consider merging ResearchResult and DevelopmentResearch classes
