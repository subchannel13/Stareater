...
namespace ExpressionParser_Tests
{
	...
	public class FunctionTests
	{
		...
		{
			var test = new ParserTester("Ceil(x)", new Var("x", 5.2), 6);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("floor(x)", new Var("x", 5.2), 5);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("if(c, x, y)", new Var("c", -1).And("x", 10).And("y", 20), 20);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("if(-1, x, y)", new Var("y", 20), 20);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("if(1, x, y)", new Var("x", 10), 10);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("if(c, x, y)", new Var("c", 1).And("x", 10).And("y", 20), 10);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("case(0)", null, 0);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("case(-1)", null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("case(1, 1)", null, 0);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("case(-1, 1)", null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("case(-1, -1)", null, 2);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("limit(x, a, b)", new Var("x", 10).And("a", 1).And("b", 3), 3);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("min(x, y)", new Var("x", 3).And("y", 5), 3);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("round(x)", new Var("x", 5.7), 6);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("sgn(x)", new Var("x", 5.7), 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("Trunc(x)", new Var("x", 5.7), 5);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("Ratio(1, 3)", null, 0.25);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("Ratio(x, y)", new Var("x", 2).And("y", 3), 0.4);
			Assert.IsTrue(test.IsOK, test.Message);
		}
	}
}
