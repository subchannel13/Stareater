...
namespace ExpressionParser_Tests
{
	...
	public class LogicalTests
	{
		...
		{
			var test = new ParserTester("1 & 1 | -1", null, null, 1);
		...
		{
			var test = new ParserTester("-5 & -7", null, null, -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("-5 & 2", null, null, -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("2 & -3", null, null, -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("0 & 1", null, null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("2 ∧ -3 ∧ 0 ∧ -1", null, null, -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("5 & 7 & x", null, new Var("x", 1), 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("5 & -7 & x", null, null, -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("a ∧ 1", null, new Var("a", -1), -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("-2 | -1 | x", null, new Var("x", 1), 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("0 | 1 | x", null, null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("-2 ∨ -3 ∨ -0.1 ∨ -1", null, null, -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("a ∨ 1", null, null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("1 @ 1 @ -1 @ x", null, new Var("x", -1), -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
