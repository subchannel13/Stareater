...
namespace ExpressionParser_Tests
{
	...
	public class ComparisonTests
	{
		...
		{
			var test = new ParserTester("5 = 7 ~ 2", null, null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("9 = 9", null, null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("a = 9", null, new Var("a", 3), -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("5 > 5", null, null, -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("9 > 8", null, null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("5 ≥ 3 ~ 2", null, null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("9 <> 7", null, null, 1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
		...
		{
			var test = new ParserTester("11 ≤ 10", null, null, -1);
			Assert.IsTrue(test.IsOK, test.Message);
		}
